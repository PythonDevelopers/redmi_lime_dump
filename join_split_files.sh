...
cat system/system/app/Notes/Notes.apk.* 2>/dev/null >> system/system/app/Notes/Notes.apk
rm -f system/system/app/Notes/Notes.apk.* 2>/dev/null
cat system/system/app/GalleryPlayerService/GalleryPlayerService.apk.* 2>/dev/null >> system/system/app/GalleryPlayerService/GalleryPlayerService.apk
rm -f system/system/app/GalleryPlayerService/GalleryPlayerService.apk.* 2>/dev/null
...
cat bootimg/15_dtbdump_~",~.dtb.* 2>/dev/null >> bootimg/15_dtbdump_~",~.dtb
rm -f bootimg/15_dtbdump_~",~.dtb.* 2>/dev/null
